...
<footer class="footer-area bg-f">
    ...
    <!-- ALL PLUGINS -->
	<script src="{{asset('template/assets/js/jquery.superslides.min.js')}}"></script>
	<script src="{{asset('template/assets/js/images-loded.min.js')}}"></script>
	<script src="{{asset('template/assets/js/isotope.min.js')}}"></script>
	<script src="{{asset('template/assets/js/baguetteBox.min.js')}}"></script>
